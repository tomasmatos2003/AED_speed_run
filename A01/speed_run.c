  ...
  while(position<final_position){
    ...
    if(variavel_teste == 1 && speed<_max_road_speed_){
      ...
      if(position_test<=final_position && teste_max_speed == 1){
        ...
        variavel_teste = 0;
        solution_3.ultimo_incremento[0] = moves;
        solution_3.ultimo_incremento[1] = position + new_speed;
        solution_3.ultimo_incremento[2] = new_speed;
      }
    }
...
static void solve_3(int final_position)
{
  ...
  solution_3_while_dynamic(solution_3.ultimo_incremento[0],solution_3.ultimo_incremento[1],solution_3.ultimo_incremento[2],final_position);
...
{
  int position_teste,position_anterior;
  int acabou = 0;
  int speed_valido=1;
  solution_4_count++;
